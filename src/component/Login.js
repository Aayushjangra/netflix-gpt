...
const toggleSignInForm = () => {
  ...
  return (
    <div> 
      ...
      <img className="h-fullscreen object-cover" src ={BG_URL}
      alt ="logo"
      />
      </div>

      <form onSubmit={(e) => e.preventDefault()} className="w-full md:w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounder-lg bg-opacity-80">
